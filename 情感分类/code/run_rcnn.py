...
from nlp.models.rcnn import TextClassifier
from keras.utils.vis_utils import plot_model

# conf-my
myconf = Config("conf/rcnn.conf")
...
def train():
    ...
    for i, k in enumerate(fields):
        ...
        if i == 0:
            plot_model(model, to_file='rcnn.png', show_shapes=True, show_layer_names=False)
...
if __name__ == "__main__":
    if len(sys.argv) != 2 or sys.argv[1] not in ["-train", "-pred"]:
        raise ValueError("""usage: python run_bigru.py [-train / -pred]""")
