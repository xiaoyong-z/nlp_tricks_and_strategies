...
if __name__ == "__main__":
    with open('tokenizer_char.pickle', 'rb') as handle:
        ...
        model1.load_weights(model_dir + "model_ltc_07.hdf5")
        ...
        model2.load_weights(model_dir + "model_ldfbd_03.hdf5")
        ...
        model3.load_weights(model_dir + "model_letf_10.hdf5")
        ...
        model4.load_weights(model_dir + "model_swt_10.hdf5")
        ...
        model5.load_weights(model_dir + "model_swa_06.hdf5")
        ...
        model6.load_weights(model_dir + "model_spc_07.hdf5")
        ...
        model7.load_weights(model_dir + "model_ssp_13.hdf5")
        ...
        # model8.load_weights(model_dir + "model_pl_09.hdf5")
        ...
        # model9.load_weights(model_dir + "model_pce_13.hdf5")
        ...
        # model10.load_weights(model_dir + "model_pd_13.hdf5")
        ...
        # model11.load_weights(model_dir + "model_ed_07.hdf5")
        ...
        # model12.load_weights(model_dir + "model_en_13.hdf5")
        ...
        # model13.load_weights(model_dir + "model_es_08.hdf5")
        ...
        # model14.load_weights(model_dir + "model_ec_07.hdf5")
        ...
        # model15.load_weights(model_dir + "model_dp_10.hdf5")
        ...
        # model16.load_weights(model_dir + "model_dt_06.hdf5")
        ...
        # model17.load_weights(model_dir + "model_dl_15.hdf5")
        ...
        # model19.load_weights(model_dir + "model_ooe_07.hdf5")
        ...
        # model20.load_weights(model_dir + "model_owta_07.hdf5")
